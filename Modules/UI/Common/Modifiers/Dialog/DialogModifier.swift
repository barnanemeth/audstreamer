...
public struct DialogModifier {
    ...
    public init(isPresented: Binding<Bool>, descriptor: DialogDescriptor) {
...
extension View {
    ...
    public func confirmationDialog(isPresented: Binding<Bool>,
                            title: String,
                            message: String? = nil,
                            actions: [DialogAction]? = nil) -> some View {
    ...
    public func dialog(isPresented: Binding<Bool>, descriptor: DialogDescriptor) -> some View {
        modifier(DialogModifier(isPresented: isPresented, descriptor: descriptor))
    }

    public func dialog(descriptor: Binding<DialogDescriptor?>) -> some View {
