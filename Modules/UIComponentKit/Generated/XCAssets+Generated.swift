...
public enum Asset {
  ...
  public enum Images {
    ...
    public static let femaleMaleCircle = ImageAsset(name: "FemaleMaleCircle")
    public static let logoLarge = ImageAsset(name: "LogoLarge")
    public static let pause = ImageAsset(name: "Pause")
    public static let play = ImageAsset(name: "Play")
    public static let skipBackward = ImageAsset(name: "SkipBackward")
    public static let skipForward = ImageAsset(name: "SkipForward")
  }
}
