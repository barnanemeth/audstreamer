...
public struct Promise<Output, Failure>: Publisher where Failure: Error {

    // MARK: Typealiases

    public typealias Fulfill = (@escaping (Result<Output, Failure>) -> Void) -> Void
    ...
    public init(_ fulfill: @escaping Fulfill) {
