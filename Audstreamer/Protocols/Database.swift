...
extension Database {
    func insertEpisodes(_ episodes: [Episode], overwrite: Bool = false) -> AnyPublisher<Void, Error> {
    ...
    func updateLastPlayedDate(for episode: Episode, date: Date = Date()) -> AnyPublisher<Void, Error> {
