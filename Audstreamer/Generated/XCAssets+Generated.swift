...
internal enum Asset {
  ...
  internal enum Images {
    ...
    internal static let femaleMaleCircle = ImageAsset(name: "FemaleMaleCircle")
    internal static let logoLarge = ImageAsset(name: "LogoLarge")
    internal static let pause = ImageAsset(name: "Pause")
    internal static let play = ImageAsset(name: "Play")
    internal static let skipBackward = ImageAsset(name: "SkipBackward")
    internal static let skipForward = ImageAsset(name: "SkipForward")
  }
}
